...
def estimate(s):
    if s == '':
        ...
        with open('cv.pkl', 'rb') as f:
            cv = pickle.load(f)
        with open('rest_model.pkl', 'rb') as f1:
        ...
        conn = mysql.connector.connect(user='root', password='Mayur1710',
...
lbl1.place(x=1050, y=230)
lbl2.place(x=1050, y=280)
e1.place(x=1290, y=230)
e2.place(x=1290, y=280)
owner_l.place(x=1200, y=340)
